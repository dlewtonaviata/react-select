		...
		value: function render() {
			...
			var props = {
				...
				onChange: function onChange(newValues) {
					if (_this2.props.multi && _this2.props.clearOptionsOnSelection) {
						// this.props.value may be null or undefined, so we have to confirm it has length prop
						var prevValueLength = _this2.props.value && _this2.props.value.length ? _this2.props.value.length : 0;
